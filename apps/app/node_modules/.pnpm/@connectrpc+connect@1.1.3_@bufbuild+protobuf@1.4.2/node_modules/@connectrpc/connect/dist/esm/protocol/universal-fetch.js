 ...
 */
export function universalClientRequestToFetch(req) {
 ...
 */
export function universalClientResponseFromFetch(res) {
    return {
        status: res.status,
        header: res.headers,
 ...
 */
export function universalServerRequestFromFetch(req, options) {
    var _a;
    return {
 ...
 */
export function universalServerResponseToFetch(res) {
    let body = null;
